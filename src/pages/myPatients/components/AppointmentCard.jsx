      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={4} md={4}>
          ...
          <Typography
            ...
            color="text.primary"
          >
         {(appointment.patient.name.length + appointment.patient.surname.length) > 15 ? (
  <Tooltip title={appointment.patient.name + " " + appointment.patient.surname}>
    <span>
      {`${appointment.patient.name} ${appointment.patient.surname}`.substring(0, 15)}...
    </span>
  </Tooltip>
) : (
